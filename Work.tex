...
%& \small{Working with WCMS team to build a tool to automatically migrate websites on an older version of Adobe %Experience Manager to a newer version with minimal manual work.}\\
%\small{Tech stack} &\footnotesize{\textbf{Java, Apache JackRabbit, Adobe Experience Manager.}} \\
%\multicolumn{2}{c}{} \\
